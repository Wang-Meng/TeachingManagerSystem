...
<br><br>
  ...
  <div id="Layer5"><p><font size="4" color="blue" ><a href="TeacherMain.jsp" style="text-decoration:none">返回</a></font><font size="4" color="black">>修改个人信息</font></p></div>
<div id="Layer1">

<form method="post" action="EditTeacherPost.jsp?teacherId=<%=rs.getString("teacherId")%>">
<table border=1 class="tableCommon">
<tr>
<td class="tdTitleRight"><p><font color=black size=3>姓名</font></p></td>
<td class="tdComponentLeft"><input type="text" name="teacherName" value="<%=rs.getString("teacherName")%>"></td></tr>
<tr>
<td class="tdTitleRight"><p><font color=black size=3>工号</font></p></td>
<td class="tdComponentLeft"><input type="text" name="teacherNo" value="<%=rs.getString("teacherNo")%>"></td></tr>
<tr>
<td class="tdTitleRight"><p><font color=black size=3>密码</font></p></td>
<td class="tdComponentLeft"><input type="text" name="password" value="<%=rs.getString("password")%>"></td></tr>
<tr>
...
<tr>
<td class="tdTitleRight"><p><font color=black size=3>部门</font></p></td>
<td class="tdComponentLeft"><input type="text" name="teacherDept" value="<%=rs.getString("teacherDept")%>"></td></tr>
