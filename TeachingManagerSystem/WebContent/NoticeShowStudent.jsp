...
<br><br>
  ...
  <div id="Layer5"><p><font size="4" color="blue" ><a href="StudentMain.jsp" style="text-decoration:none">返回</a></font><font size="4" color="black">>公告信息信息</font></p></div>
<div id="Layer1">
<h2 align="center"><font color=black><%=rs.getString("noticeName")%></font></h2>
<p><font color=black size=3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=rs.getString("noticeContent")%></font></p><br>
