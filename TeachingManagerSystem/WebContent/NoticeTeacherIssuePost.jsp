...
rs.updateString("tName",request.getParameter("Ntname"));
rs.updateString("noticeName",request.getParameter("Nname"));
rs.updateString("noticeContent",request.getParameter("Ncontent"));
