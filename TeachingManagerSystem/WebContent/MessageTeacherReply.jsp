...
<br><br>
  ...
  <div id="Layer4"><p><font size="6" color="white">回复留言栏</font></p></div>
  <div id="Layer5"><p><font size="4" color="blue" ><a href="MessageTeacher.jsp" style="text-decoration:none">返回</a></font><font size="4" color="black">>回复信息输入</font></p></div>
  
<form name="form1" method="post" action="MessageTeacherReplyPost.jsp">
<div id="Layer1"><br>
